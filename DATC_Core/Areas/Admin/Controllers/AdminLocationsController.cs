...
namespace DATC_Core.Areas.Admin.Controllers
{
    ...
    public class AdminLocationsController : Controller
    {
        ...
        public AdminLocationsController(DATCCoreMineDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Locations != null ? 
                          ...
                          Problem("Entity set 'DATCCoreMineDBContext.Locations'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("LocationId,Name,Type,Slug,NameWithType,PayWithType,ParentCode,Levels")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LocationId,Name,Type,Slug,NameWithType,PayWithType,ParentCode,Levels")] Location location)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DATCCoreMineDBContext.Locations'  is null.");
            }
            var location = await _context.Locations.FindAsync(id);
            if (location != null)
            {
